...
class Cylinder(utils.MuJoCoElement):
    def __init__(
            self,
            name: str | None = None,
        ...
        self.area = utils.Attribution("area", area, float, 1.0)
        self.diameter = utils.Attribution("diameter", diameter, float)
        self.bias = utils.Attribution("bias", bias, float, (0.0, 0.0, 0.0))
    ...
    def __str__(self) -> str:
        return f"<Cylinder{utils.arrange_attributions(self.get_attributions())}>"
